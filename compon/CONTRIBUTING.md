Contribution Guide for components project
====================================
...
### Scope
In our project scope refers to component which is touched by changes.
...
## Merge Request reviews comments
...
* `r? @arubtsov`: request for review from another user
* `re-r? @arubtsov`: request another user to do review again
* `cc @arubtsov, @sklochanov`: current message is also intended for...
